within GroundVehicleDynamics.Examples.SensorUsage;

model DiscEdgeAltitude_ex01
  ...
  Sensors.DiscEdgeAltitude discEdgeAltitude(rDisc = Wheel.diameter/2)  annotation(
    Placement(transformation(origin = {124, 196}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  GroundVehicleDynamics.Sensors.DiscEdgeAltitude discEdgeAltitude1(rDisc = Wheel1.diameter/2) annotation(
    Placement(transformation(origin = {404, 200}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
equation
  ...
  connect(Wheel.frame_b, discEdgeAltitude.frame_a) annotation(
    Line(points = {{166, 220}, {124, 220}, {124, 206}}, color = {95, 95, 95}));
  connect(Wheel1.frame_a, discEdgeAltitude1.frame_a) annotation(
    Line(points = {{284, 220}, {404, 220}, {404, 210}}, color = {95, 95, 95}));
  annotation(
